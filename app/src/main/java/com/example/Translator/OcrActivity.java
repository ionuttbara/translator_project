...
public class OcrActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setSubtitle("Apasa pe butonul imagine pentru a importa o imagine");
        ...
        ocrTranslateButton.setOnClickListener(view -> {
    ...
    private void showImageImportDialog() {
        ...
        String[] items = {" Camera", " Aplicatie galerie"};
        AlertDialog.Builder dialog = new AlertDialog.Builder(this);
        //set title
        dialog.setTitle("Alege imagine");
    ...
    private void pickCamera() {
        ...
        //description
        values.put(MediaStore.Images.Media.DESCRIPTION, "Imagine in text");
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if(resultCode == RESULT_OK) {
                ...
                if (!recognizer.isOperational()) {
                    ...
                    if(items.size() == 0) {
                        Toast.makeText(this, "Nu exista text in imagine/", Toast.LENGTH_SHORT).show();
                        mResultEt.setText("Nu exista text in imagine");
                        ocrTranslateButton.setEnabled(false);
                    } else {
                    ...
                    mResultEt.setText(sb.toString());
                        if(!mResultEt.getText().toString().isEmpty() && !mResultEt.getText().toString().equals("Textul nu a fost gasit in imaginea selectata")) {
